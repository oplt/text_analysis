...
| Executable R/quanteda analysis | none | none | INTERNAL / MISSING | Optional parity and script export exist; no runner is implemented. See `docs/r-quanteda-architecture.md`. |
