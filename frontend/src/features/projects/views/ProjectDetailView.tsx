...
import { ArrowBack as BackIcon, AssignmentTurnedIn as DoneIcon, CalendarMonth as CalendarIcon, PlaylistAddCheck as TaskIcon, ViewKanban as BoardIcon } from "@mui/icons-material";
...
export default function ProjectDetailPage() {
    ...
    return <PageShell maxWidth="xl"><Stack direction="row" sx={{ mb: 2 }}><Button variant="outlined" startIcon={<BackIcon />} onClick={() => m.navigate("/projects")}>Back to projects</Button></Stack>
