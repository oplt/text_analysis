...
export type AnalysisCapabilities = {
    operations: Record<string, { async: boolean; default_execution_mode?: string }>;
...
export async function getDocumentIngestionQa(
    ...
    return apiFetch(`${BASE}/documents/${documentId}/ingestion-qa${query}`, { signal });
}

export async function listCleaningProfiles(
    projectId: string,
    signal?: AbortSignal
): Promise<CleaningProfile[]> {
    return apiFetch(`${BASE}/projects/${projectId}/cleaning-profiles`, { signal });
}
...
export async function getSourceText(
    ...
    return apiFetch(`${BASE}/documents/${documentId}/source-text`, { signal });
}
...
export async function listLabels(
    ...
    return apiFetch(`${BASE}/codebooks/${codebookId}/labels`, { signal });
}
...
export async function getAnnotationProgress(
    ...
    return apiFetch(`${BASE}/corpora/${corpusId}/annotations/progress`, { signal });
}
...
export async function getTextUnitContext(
    ...
    return apiFetch(`${BASE}/text-units/${textUnitId}/context?window=${window}`, { signal });
}
...
export async function listAdjudications(
    ...
    return apiFetch(`${BASE}/corpora/${corpusId}/adjudications`, { signal });
}
...
export async function listCampaignDisagreements(
    ...
    return apiFetch(`${BASE}/annotation-campaigns/${campaignId}/disagreements${query}`, { signal });
}
...
export async function listCampaignAdjudications(
    ...
    return apiFetch(`${BASE}/annotation-campaigns/${campaignId}/adjudications`, { signal });
}
...
export async function getClassifierCoefficients(
    ...
    return apiFetch(`${BASE}/classifiers/${modelId}/coefficients`, { signal });
}
...
export async function listUncertainPredictions(
    ...
    return apiFetch(`${BASE}/classifiers/${modelId}/active-learning/queue?${search}`, { signal });
}
...
export async function getClassifier(
    ...
    return apiFetch(`${BASE}/classifiers/${encodeURIComponent(modelId)}`, { signal });
}
...
export async function listModelLifecycleEvents(
    modelId: string,
    signal?: AbortSignal
): Promise<ModelLifecycleEvent[]> {
    return apiFetch(`${BASE}/models/${encodeURIComponent(modelId)}/lifecycle-events`, { signal });
}
...
export async function listTopicLabels(
    ...
    return apiFetch(`${BASE}/topics/${runId}/labels`, { signal });
}
...
export async function getRunResults(
    ...
    return apiFetch(`${BASE}/runs/${encodeURIComponent(runId)}/results?${query}`, { signal });
}
...
export async function compareRuns(
    ...
    return apiFetch(`${BASE}/runs/${runAId}/compare/${runBId}`, { signal });
}
...
export async function getQuantedaScript(
    corpusId: string,
    signal?: AbortSignal
): Promise<{ script: string }> {
    return apiFetch(`${BASE}/corpora/${corpusId}/export/quanteda-script`, { signal });
}
...
export async function listContextualDatasets(
    ...
    return apiFetch(`${BASE}/projects/${projectId}/contextual-datasets`, { signal });
}
...
export async function getContextualDataset(
    ...
    return apiFetch(`${BASE}/contextual-datasets/${datasetId}`, { signal });
}
...
export async function listContextualObservations(
    ...
    return apiFetch(`${BASE}/contextual-datasets/${datasetId}/observations?${search}`, { signal });
}
...
export type CitationSourceCoordinate = {
    scope_type: "page" | "parsed_document" | "canonical_document";
    scope_id: string;
...
export async function getAssistantScope(
    ...
    return apiFetch(`${BASE}/corpora/${corpusId}/assistant/scope`, { signal });
}
...
export async function listAssistantThreads(
    ...
    return apiFetch(`${BASE}/corpora/${corpusId}/assistant/conversations`, { signal });
}
...
export async function getAssistantConversation(
    ...
    return apiFetch(`${BASE}/assistant/conversations/${threadId}`, { signal });
}
...
export async function listResearchMemos(
    ...
    return apiFetch(`${BASE}/projects/${projectId}/memos${query}`, { signal });
}
