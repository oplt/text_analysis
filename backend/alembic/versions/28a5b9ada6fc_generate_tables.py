...
Revision ID: 28a5b9ada6fc
Revises:
Create Date: 2026-06-19 20:11:38.624579
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ai_evaluation_datasets_user_id"),
        "ai_evaluation_datasets",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ai_prompt_templates_key"), "ai_prompt_templates", ["key"], unique=False
    )
    op.create_index(
        op.f("ix_ai_prompt_templates_user_id"), "ai_prompt_templates", ["user_id"], unique=False
    )
    op.create_table(
        "api_keys",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_calendar_entries_user_id"), "calendar_entries", ["user_id"], unique=False
    )
    op.create_table(
        "memory_audit_logs",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_memory_audit_logs_agent_id"), "memory_audit_logs", ["agent_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_audit_logs_created_at"), "memory_audit_logs", ["created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_memory_audit_logs_memory_level"),
        "memory_audit_logs",
        ["memory_level"],
        unique=False,
    )
    op.create_index(
        op.f("ix_memory_audit_logs_operation"), "memory_audit_logs", ["operation"], unique=False
    )
    op.create_index(
        op.f("ix_memory_audit_logs_project_id"), "memory_audit_logs", ["project_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_audit_logs_run_id"), "memory_audit_logs", ["run_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_audit_logs_user_id"), "memory_audit_logs", ["user_id"], unique=False
    )
    op.create_table(
        "memory_registry",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        op.f("ix_memory_registry_agent_id"), "memory_registry", ["agent_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_memory_registry_memory_level"), "memory_registry", ["memory_level"], unique=False
    )
    op.create_index(
        op.f("ix_memory_registry_project_id"), "memory_registry", ["project_id"], unique=False
    )
    op.create_index(op.f("ix_memory_registry_run_id"), "memory_registry", ["run_id"], unique=False)
    op.create_index(op.f("ix_memory_registry_status"), "memory_registry", ["status"], unique=False)
    op.create_index(
        op.f("ix_memory_registry_user_id"), "memory_registry", ["user_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_rag_documents_organization_id"), "rag_documents", ["organization_id"], unique=False
    )
    op.create_index(
        op.f("ix_rag_documents_project_id"), "rag_documents", ["project_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_subscriptions_plan_id"), "user_subscriptions", ["plan_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_ai_document_chunks_document_id"),
        "ai_document_chunks",
        ["document_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ai_evaluation_cases_dataset_id"),
        "ai_evaluation_cases",
        ["dataset_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["prompt_template_id"], ["ai_prompt_templates.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_ai_prompt_versions_prompt_template_id"),
        "ai_prompt_versions",
        ["prompt_template_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_project_tasks_assignee_id"), "project_tasks", ["assignee_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_rag_chunks_organization_id"), "rag_chunks", ["organization_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_rag_ingestion_jobs_document_id"),
        "rag_ingestion_jobs",
        ["document_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_rag_ingestion_jobs_status"), "rag_ingestion_jobs", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_rag_ingestion_jobs_user_id"), "rag_ingestion_jobs", ["user_id"], unique=False
    )
    op.create_table(
        "ai_evaluation_runs",
        sa.Column("id", sa.String(), nullable=False),
        ...
        sa.ForeignKeyConstraint(["dataset_id"], ["ai_evaluation_datasets.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["prompt_version_id"], ["ai_prompt_versions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_ai_evaluation_runs_dataset_id"), "ai_evaluation_runs", ["dataset_id"], unique=False
    )
    op.create_index(
        op.f("ix_ai_evaluation_runs_prompt_version_id"),
        "ai_evaluation_runs",
        ["prompt_version_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_evaluation_runs_user_id"), "ai_evaluation_runs", ["user_id"], unique=False
    )
    op.create_table(
        "ai_runs",
        sa.Column("id", sa.String(), nullable=False),
        ...
        sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["evaluation_case_id"], ["ai_evaluation_cases.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["evaluation_dataset_id"], ["ai_evaluation_datasets.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["prompt_template_id"], ["ai_prompt_templates.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_ai_runs_evaluation_case_id"), "ai_runs", ["evaluation_case_id"], unique=False
    )
    op.create_index(
        op.f("ix_ai_runs_evaluation_dataset_id"), "ai_runs", ["evaluation_dataset_id"], unique=False
    )
    op.create_index(
        op.f("ix_ai_runs_prompt_template_id"), "ai_runs", ["prompt_template_id"], unique=False
    )
    op.create_index(
        op.f("ix_ai_runs_prompt_version_id"), "ai_runs", ["prompt_version_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["evaluation_case_id"], ["ai_evaluation_cases.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_ai_evaluation_run_items_ai_run_id"),
        "ai_evaluation_run_items",
        ["ai_run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_evaluation_run_items_evaluation_case_id"),
        "ai_evaluation_run_items",
        ["evaluation_case_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_evaluation_run_items_evaluation_run_id"),
        "ai_evaluation_run_items",
        ["evaluation_run_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ai_review_items_assigned_to_user_id"),
        "ai_review_items",
        ["assigned_to_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_review_items_requested_by_user_id"),
        "ai_review_items",
        ["requested_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ai_review_items_reviewed_by_user_id"),
        "ai_review_items",
        ["reviewed_by_user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_ai_evaluation_run_items_evaluation_run_id"), table_name="ai_evaluation_run_items"
    )
    op.drop_index(
        op.f("ix_ai_evaluation_run_items_evaluation_case_id"), table_name="ai_evaluation_run_items"
    )
    op.drop_index(
        op.f("ix_ai_evaluation_run_items_ai_run_id"), table_name="ai_evaluation_run_items"
    )
    ...
    op.drop_index(op.f("ix_memory_audit_logs_external_memory_id"), table_name="memory_audit_logs")
