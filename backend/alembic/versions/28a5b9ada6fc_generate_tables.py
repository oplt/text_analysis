...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_memory_audit_logs_agent_id'), 'memory_audit_logs', ['agent_id'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_created_at'), 'memory_audit_logs', ['created_at'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_external_memory_id'), 'memory_audit_logs', ['external_memory_id'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_memory_level'), 'memory_audit_logs', ['memory_level'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_operation'), 'memory_audit_logs', ['operation'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_project_id'), 'memory_audit_logs', ['project_id'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_run_id'), 'memory_audit_logs', ['run_id'], unique=False)
    op.create_index(op.f('ix_memory_audit_logs_user_id'), 'memory_audit_logs', ['user_id'], unique=False)
    op.create_table('memory_registry',
    sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_memory_registry_agent_id'), 'memory_registry', ['agent_id'], unique=False)
    op.create_index(op.f('ix_memory_registry_external_memory_id'), 'memory_registry', ['external_memory_id'], unique=True)
    op.create_index(op.f('ix_memory_registry_memory_level'), 'memory_registry', ['memory_level'], unique=False)
    op.create_index(op.f('ix_memory_registry_project_id'), 'memory_registry', ['project_id'], unique=False)
    ...
    op.create_index(op.f('ix_memory_registry_user_id'), 'memory_registry', ['user_id'], unique=False)
